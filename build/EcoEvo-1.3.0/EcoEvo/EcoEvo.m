...
JoinFirst;
PlotDynamics;ListLinePlot3D;RuleListPlot;
...
WeightedAbundance;
TraitMean;TraitVariance;TotalAbundance;
...
$EcoEvoVersion="1.3.0 (January 11, 2020)";
...
TemporalMean[f_?InterpolatingFunctionFunctionQ,var_Symbol:t,opts___?OptionQ]:=Module[{nintegrateopts,ifdomains,numifdomains,varmin,varmax},
	...
	Which[
		numifdomains==0,
		Msg[TemporalMean::norange],
		numifdomains>1,
		Msg[TemporalMean::unkrange],
		Else,
...
TemporalVariance[if_?InterpolatingFunctionFunctionQ,var_:t,opts___?OptionQ]:=Module[{nintegrateopts,avgopts,ifdomains,numifdomains,varmin,varmax},
	...
	Which[
		numifdomains==0,
		Msg[TemporalVariance::norange],
		numifdomains>1,
		Msg[TemporalVariance::unkrange],
		Else,
		{varmin,varmax}=ifdomains[[1]];
...
TemporalCovariance[if1_,if2_?InterpolatingFunctionFunctionQ,var_:t,opts___?OptionQ]:=Module[{nintegrateopts,avgopts,ifdomains,numifdomains,varmin,varmax},
	...
	Which[
		numifdomains==0,
		Msg[TemporalCovariance::norange],
		numifdomains>1,
		Msg[TemporalCovariance::unkrange],
		Else,
		{varmin,varmax}=ifdomains[[1]];
...
(*Print["vars=",vars];*)
If[Length[vars]!=2&&Length[vars]!=3,Msg[RuleListPlot::baddim,Length[vars]];Return[$Failed]];
...
WeightedAbundance[sol_?VariablesQ,guild_:Automatic,weightfunction_:"Total",opts___?OptionQ]:=
Module[{
...
Return[
	Flatten[
		Table[
			Table[
				gtrait->Reinterpolation[Moment[WeightedData[Table[Subscript[gtrait, i],{i,\[ScriptCapitalN][gu]}]/.traits,Chop[Table[Subscript[gu, i],{i,\[ScriptCapitalN][gu]}]/.WeightedAbundance[sol,gu,weightfunction]]],1]]
			,{gtrait,gtraits[gu]}]
		,{gu,guilds}]
	]
]
		...
		Table[
			Table[
				Var[gtrait]->Reinterpolation[CentralMoment[
					WeightedData[Table[Subscript[gtrait, i],{i,\[ScriptCapitalN][gu]}]/.traits,Chop[Table[Subscript[gu, i],{i,\[ScriptCapitalN][gu]}]/.WeightedAbundance[sol,gu,weightfunction]]],2]]
			,{gtrait,gtraits[gu]}]
		,{gu,guilds}]
	]
]
...
Return[
	Table[
		gu->Reinterpolation[Sum[Subscript[gu, i],{i,\[ScriptCapitalN][gu]}]/.WeightedAbundance[sol,gu,weightfunction]]
	,{gu,guilds}]
]
...
abunds=WeightedAbundance[sol,gu,weightfunction];
