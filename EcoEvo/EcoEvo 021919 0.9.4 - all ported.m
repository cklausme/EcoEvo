...
$EcoEvoVersion="0.9.4X (February 19, 2019)";
...
Options[EcoEqns]={Fixed->{},TimeScale->1,Logged->False,PerCapita->False};
...
eqns=EcoEqns[traits,Fixed->fixed,opts];
...
Which[
	...
	res=Transpose[RecurrenceTable[Join[eqns,ics],unks,{t,0,tmax},Method->{Compiled->False}]];
...
Which[
	...
	unksics=Table[{var/.ToUnks,var/.traits/.pops},{var,nonfixedvars}];
...
,
	...
	constraints=Table[Min[traitrange[guild,tr]]<=Subscript[trait[guild,tr],0]<=Max[range[guild,tr]],{tr,ntraits[guild]}]
,
	Else,
	constraints=Join[constraints,Table[Min[traitrange[guild,tr]]<=Subscript[trait[guild,tr],0]<=Max[range[guild,tr]],{tr,ntraits[guild]}]]
];
