...
NotebookDataLength[     14960,        489]
NotebookOptionsPosition[     11217,        374]
NotebookOutlinePosition[     13637,        441]
CellTagsIndexPosition[     13552,        436]
...
TaggingRules->{
 "ModificationHighlight" -> False, "ColorType" -> "SymbolColor", "LinkTrails" -> 
  ...
  None, "RootCaptions" -> "", 
  "Metadata" -> {
   "built" -> "{2020, 8, 29, 22, 34, 21.171565}", 
...
(*CellTagsIndex
CellTagsIndex->{
 {"PrimaryExamplesSection", 13408, 429}
 }
*)
(*NotebookFileOutline
Notebook[{
